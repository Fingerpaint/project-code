...
/**
 * CellList that is used to show all results, of which the user can select some
 * that he/she wants to compare.
 * 
 * @author Group Fingerpaint
 */
public class ComparePerformanceCellList extends CellList<String> implements
		Handler<String> {
	 ...
	 */
	public ComparePerformanceCellList() {
		super(new TextCell());
