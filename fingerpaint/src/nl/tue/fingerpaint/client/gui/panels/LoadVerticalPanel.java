...
public class LoadVerticalPanel extends VerticalPanel {
	 ...
	 */
	public void updateNoFilesFoundLabel(CellList<String> list){
		if(list == null){
			throw new NullPointerException();
		}
		if(list.getVisibleItemCount() == 0){
			GuiState.loadVerticalPanel.add(noFilesFoundLabel);
		}else{
			GuiState.loadVerticalPanel.remove(noFilesFoundLabel);
		}
	}
}
