...
/**
 * Provides the standard set of {@link DesiredCapabilities browsers} and
 * {@link Dimension Dimension's} used in the test environment for the
 * Fingerpaint project.
 * 
 * Currently the browsers in the standard testing environment are the newest
 * versions of:
 * 
 * <ul>
 ...
 * </ul>
 * 
 * Of these browser, Microsoft Internet Explorer and Apple Safari are currently
 * running in sequential mode because of problems during multi-threading.
 * 
...
public class StandardCapabilitiesProvider implements CapabilitiesProvider {
	...
	private static final Dimension[] DIMENSIONS = new Dimension[] {
			new Dimension(1600, 900), new Dimension(1280, 800),
			new Dimension(800, 1280), new Dimension(960, 540),
			new Dimension(540, 960) };

	/**
	 * Returns the standard list of currently used browsers in the Fingerpaint
	 * testing environment:
	 * 
	 * <ul>
	 * <li>Mozilla Firefox</li>
	...
	/**
	 * Returns the list of browsers that currently needs to run in sequential
	 * mode because of problems with multi-threading.
	 * 
	 * <ul>
	 * <li>Microsoft Internet Explorer</li>
	 * <li>Apple Safari</li>
	...
	/**
	 * Returns the list of dimensions that are currently tested in the
	 * Fingerpaint testing environment.
	 * 
	 * <ul>
	 * <li>Desktop: 1600x900</li>
	 * <li>Tablet horizontal: 1280x800</li>
